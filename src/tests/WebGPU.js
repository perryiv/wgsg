...
import { getData } from "../lib/Tools/WebGPU";
...
describe ( "WebGPU", function ()
{
	...
	{
		expect ( navigator ).to.be.an ( "object" );
		expect ( navigator.gpu ).to.be.an ( "object" );
	} );
	...
	describe ( "getData", function ()
	{
		it ( "Make sure WebGPU is supported", async function ()
		{
			...
			{
				console.error ( "Error when getting WebGPU data:", error );
				assert.fail ( "WebGPU is not supported" );
			} 
		} );
